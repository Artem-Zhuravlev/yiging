...
/**
 * Classical text for the 64 hexagrams: judgment (King Wen's Thwan), image (the Great
 * Symbolism), and the 6 line statements (the Duke of Kau's Yao). Source: James Legge,
 * 'The Yi King' (Sacred Books of the East, vol. 16), 1899 - public domain (see SPEC-002).
 * Transcribed from a public-domain digitization (baharna.com's Legge edition) and
 * cross-checked against a second independent source (the Chinese Text Project,
 * ctext.org) on a sample spanning the set - exact match on every phrase checked.
 *
 * @phpstan-type HexagramText array{judgment: string, image: string, lineStatements: list<string>}
 */
final class HexagramTextCatalog
{
    ...
    private const ENTRIES = [
        ...
        47 => [
            ...
            'lineStatements' => [
                ...
                'The sixth SIX, divided, shows its subject straitened, as if bound with creepers; or in a high and dangerous position, and saying (to himself), \'If I move, I shall repent it.\' If he do repent of former errors, there will be good fortune in his going forward.',
            ],
        ],
        48 => [
